		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="content">
					...
					<div class="post">
						<h2 class="title"><a href='/www/main.php/news/<?php echo $newsItem['id'] ;?>'><?php echo $newsItem['title'].' # '.$newsItem['id'];?></a></h2>
						<p class="meta">Posted by <a href="#'<?php echo $newsItem['author_name'];?>'"><?php echo $newsItem['author_name'];?></a> on <?php echo $newsItem['date'];?>
							&nbsp;&bull;&nbsp; <a href='/www/main.php/news/<?php echo $newsItem['id'] ;?>' class="permalink"> Full article</a></p>
						<div class="entry">
